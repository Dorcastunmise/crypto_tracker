...
const CoinArea = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-900/90 text-white
    px-4 sm:px-[5%] py-6 md:py-10 relative z-0'>
        {/*Hero Section */}
        <div className='text-center mb-8 md:mb-12 space-y-4 group relative'>
            <div className='absolute inset-0 bg-gradient-to-r from-emerald-500/10 blur-3xl
            opacity-30 animate-pulse-slow'/>
            <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from bg-emerald-400
            via-cyan-300 to-emerald-400 bg-clip-text text-transparent animate-gradient-x leading-tight'>
                Crypto <br/>
                <span className='text-xl sm:text-2xl md:text-3xl lg:text-4xl bg-gradient-to-r from-cyan-400 to-emerald-600
        ...
        {/*Task Header */}
        <div className='grid grid-cols-5 gap-4 text-sm py-4 px-4 mb-2 bg-gray-800/40 backdrop-blur-lg rounded-xl border border-emerald-500/20'>
            <p className='text-emerald-600/90'>Rank</p>
            <p className='text-emerald-300/90'>Coins</p>
            <div className='relative flex items-center gap-1 cursor-pointer group text-cyan-200/90 '
            onClick={() => setIsCurrencyDropdownOpen(!isCurrencyDropdownOpen)}>
                ...
                <div className='flex items-center gap-1'>
                    ...
                    <ChevronDown className={`w-4 h-4 text-cyan-400/80 transition-transform ${isCurrencyDropdownOpen ? "rotate-180" : ""}`} />
                </div>
            </div>
            <p className='text-center text-emerald-300/90'>24H Flux</p>
            <p className='text-right text-emerald-600/90'>Market Cap</p>
        </div>
                ...
                <Link to={`/crypto/${item.id}`} 
                    ...
                    <div className='md:hidden space-y-3'>
                        ...
                        <div className='flex items-center justify-between pt-2 border-t border-emerald-500/10'>
                            ...
                            <div className='text-right'>
                                ...
                                <p className='text-sm text-emerald-400/80 hover:text-emerald-300 transition-colors duration-200 mt-0.5'>
                    ...
                    <div className='hidden md:grid grid-cols-5 gap-4 items-center'>
                        ...
                        <div className='text-right'>
                            ...
                            <p className='text-sm lg:text-base text-emerald-400/80 hover:text-emerald-300 transition-colors duration-200 mt-0.5'>
                                Vol: {currentCurrency.symbol}{item.total_volume.toLocaleString()}
                            </p>
                        </div>
                    </div>
